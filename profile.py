...
this_node.addService(rspec.Execute(shell="sh", command="chmod +x /local/repository/install.sh"))
this_node.addService(rspec.Execute(shell="sh", command="/local/repository/install.sh"))
